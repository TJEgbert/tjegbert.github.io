...
function init()
{
   ...
   //Inset the HTML code for the first puzzle
...
{
   if(confirm("You lose all of your work on the puzzle.  Continue?"))
   {
...
function setupPuzzle()
{
   ...
   //set the intial color to be gold
   for(var i = 0; i < puzzleCells.length; i++)
   {
      puzzleCells[i].style.backgroundColor = "rgb(233,207,29)";
   
   
      //set the cell color in repsonse to a mousedown event
   ...
   function()
   {
      ...
      // Display incorrect grey cell in red
...
function setBackground(event)
{
   ...
   event.target.style.backgroundColor = cellBackground;
