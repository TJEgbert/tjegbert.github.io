...
window.addEventListener("load", function(){
   ...
   formDate = formDate.replace(/\+/g, " "); //gloably replace the + with spaces
   formDate = decodeURIComponent(formDate); // decoding %24 to render $, decode %28 to render (
   var formFields = formDate.split(/[&=]/g);
...
function luhn(idNum)
{
   ...
   //return whether the sum of the digitals is divisible by 10
